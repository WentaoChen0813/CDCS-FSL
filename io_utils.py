...
def parse_args(script):
    ...
    if script == 'train':
        ...
        parser.add_argument('--loss_type'   , default='dist'     , help='loss_type for baseline++')
        parser.add_argument('--supervised_align', action='store_true')
        parser.add_argument('--ad_align'    , action='store_true')
        parser.add_argument('--unlabeled_proportion', default=1., type=float)
        ...
        parser.add_argument('--update_teacher', default='step', choices=['step', 'epoch'])
        ...
        parser.add_argument('--fixmatch_noaug', action='store_true')
        parser.add_argument('--fixmatch_1batch', action='store_true')
