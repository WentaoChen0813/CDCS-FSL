...
def parse_args(script):
    ...
    parser.add_argument('--method'      , default='baseline',   help='baseline/baseline++/protonet/deepemd/metaoptnet/matchingnet/relationnet{_softmax}/maml{_approx}') #relationnet_softmax replace L2 norm with softmax to expedite training, maml_approx use first-order approximation in the gradient for efficiency
    ...
    if script == 'train':
        ...
        parser.add_argument('--fixmatch_weak', default=1, type=int)
        ...
        parser.add_argument('--classcontrast_bs', default=128, type=int)
